<?php 
	...
	if(isset($_POST['mApprove'])){
		$sql1 = "update undolt.manager set approved ='Yes' where mid = $mid;";
	...
	if(isset($_POST['mDisapprove'])){
		$stmt2 = $conn->prepare("DELETE FROM undolt.manager where mid=:t;");
		...
		error_reporting( E_ALL );
         ...
         $message = "
					...
					<body>
					<h2> $name you have been not selected</h2>
