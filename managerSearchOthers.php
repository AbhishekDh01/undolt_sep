...
<body>
	...
	<select name="sid" class="selectpicker" data-live-search="true">
		...
		<?php
			...
			while ($row=$stmt->fetch(PDO::FETCH_ASSOC)){
					$sid = $row['sid'];
					echo "<option data-tokens='s$sid' value=$sid>";
					echo $sid;
					echo'</option>';
			}
	...
	<select name="qid" class="selectpicker" data-live-search="true">
		...
		<?php
			...
			while ($row=$stmt->fetch(PDO::FETCH_ASSOC)){
					...
					echo "<option value='$qid' data-tokens='q$qid $sub'>";
					echo $qid;
					echo " - ";
					echo $sub;
					// echo " (sid - ";
	...
	<select name="tid" class="selectpicker" data-live-search="true">
		...
		<?php
			...
			while ($row=$stmt->fetch(PDO::FETCH_ASSOC)){
					$tid = $row['assignTid'];
					echo "<option value='$tid' data-tokens='t$tid'>";
					// echo $row['tName'];
					// echo " - ";
					echo $tid;
					echo'</option>';
