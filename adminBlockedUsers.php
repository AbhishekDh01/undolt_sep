...
<body>
	...
	<?php
	$i=1;
	$stmt = $conn->query("SELECT * FROM undolt.manager WHERE banned=1;");
...
<h2>Tutors</h2>
	...
	<?php
	$i=1;
	$stmt1 = $conn->query("SELECT * FROM undolt.tutor WHERE banned=1;");
...
<h2>Students</h2>
	...
	<?php
	$i=1;
	$stmt3 = $conn->query("SELECT * FROM undolt.student WHERE banned=1;");
