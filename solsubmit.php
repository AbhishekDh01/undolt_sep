...
<?php
	...
	$qid = $_POST['qid'];
		...
		$sql1 = "update undolt.assignment set solInfo ='".$_POST['solInfo']."' where qid = $qid;";
		$sql2 = "update undolt.assignment set aStatus = 'Solved and in Review' where qid = $qid;";
		$sql3 = "update undolt.assignment set sol1 = '".$fileArr[0]."' where qid = $qid;";
		$sql4 = "update undolt.assignment set sol2 = '".$fileArr[1]."' where qid = $qid;";
		$sql5 = "update undolt.assignment set sol3 = '".$fileArr[2]."' where qid = $qid;";
		$sql6 = "update undolt.assignment set sol4 = '".$fileArr[3]."' where qid = $qid;";
		$sql7 = "update undolt.assignment set sol5 = '".$fileArr[4]."' where qid = $qid;";
