<?php  
	...
	session_start();
	$aid=$_SESSION['navAid'];
	$stmt = $conn->query("SELECT * FROM undolt.admin where aid=$aid");
...
<body>
	...
	<button onclick="location.href='adminApproveTutor.php';">New Tutor</button>
	...
	<button onclick="location.href='adminAllDatabase.php';">All Database</button>
