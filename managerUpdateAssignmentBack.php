<?php
	...
	if (isset($_POST['assignSubmit'])) {
		...
		$stmtt = $conn->query("SELECT * FROM undolt.sreferral where sid = $sid;");
		$rowt=$stmtt->fetch(PDO::FETCH_ASSOC);

		$sql1 = "update undolt.assignment set subject ='".$_POST['subject']."' where qid = $qid;";
		$sql2 = "update undolt.assignment set topic ='".$_POST['topic']."' where qid = $qid;";
		$sql3 = "update undolt.assignment set info ='".$_POST['info']."' where qid = $qid;";
		$sql4 = "update undolt.assignment set price ='".$_POST['price']."' where qid = $qid;";
		$sql5 = "update undolt.assignment set deadline ='".$_POST['date']."' where qid = $qid;";
		$sql6 = "update undolt.assignment set aStatus = 'Approved' where qid = $qid;";
		$sql7 = "update undolt.assignment set approvedByMid ='".$mid."' where qid = $qid;";
		$sql8 = "update undolt.assignment set assignTid ='-999' where qid = $qid;";
		$sql9 = "update undolt.assignment set tPrice ='".$_POST['tPrice']."' where qid = $qid;";
		$sql10 = "update undolt.sreferral set applicable_ref = applicable_ref+1 where sid = '".$rowt['referral_sid']."';";
		$sql11 = "update undolt.sreferral set first_order ='done' where sid = $sid;";
		...
		$sql14 = "update undolt.assignment set ref_used = 1 where qid = $qid;";
