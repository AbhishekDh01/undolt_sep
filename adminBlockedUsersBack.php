<?php  
	...
	if (isset($_POST['unblockStudent'])) {
		$sid = $_POST['sid'];
		$sql15 = "update undolt.student set banned = 0 where sid = $sid;";
	...
	if (isset($_POST['unblockTutor'])) {
		$tid = $_POST['tid'];
		$sql16 = "update undolt.Tutor set banned = 0 where tid = $tid;";
	...
	if (isset($_POST['unblockManager'])) {
		$mid = $_POST['mid'];
		$sql17 = "update undolt.manager set banned = 0 where mid = $mid;";
