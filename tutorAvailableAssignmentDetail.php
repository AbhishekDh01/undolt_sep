...
<body>
	...
	if(isset($_POST['takeAssign'])){
		$sql1 = "update undolt.assignment set assignTid ='".$_POST['tid']."' where qid = '".$_POST['qid']."';";
		$sql2 = "update undolt.assignment set aStatus = 'Accepted by Tutor' where qid = '".$_POST['qid']."';";
	...
	<?php  
		...
		if(isset($_POST['uploadNew'])){
			...
			$i=1;
				...
				$sql8 = "update undolt.assignment set aStatus = 'Accepted by Tutor' where qid = $qid;";
